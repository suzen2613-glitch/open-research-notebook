...
ROOT_DIR="/home/sunshuheng/Downloads/open-notebook"
...
PDF_PATH="${1:-/home/sunshuheng/miniconda3/envs/open-notebook/lib/python3.12/site-packages/matplotlib/mpl-data/images/help.pdf}"
...
/home/sunshuheng/.surrealdb/surreal start \
  --log warn \
  --user root \
