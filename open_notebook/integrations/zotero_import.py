...
ZOTERO_DB_PATH = Path(os.getenv("ZOTERO_DB_PATH", "/home/sunshuheng/Zotero/zotero.sqlite"))
ZOTERO_STORAGE_DIR = Path(os.getenv("ZOTERO_STORAGE_DIR", "/home/sunshuheng/Zotero/storage"))
