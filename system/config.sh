...
API_DIR="$PROJECT_DIR"
CONDA_PYTHON="${OPEN_NOTEBOOK_CONDA_PYTHON:-/home/sunshuheng/miniconda3/envs/open-notebook/bin/python}"
WORKER_BIN="${OPEN_NOTEBOOK_WORKER_BIN:-/home/sunshuheng/miniconda3/envs/open-notebook/bin/surreal-commands-worker}"
SURREAL_BIN="${OPEN_NOTEBOOK_SURREAL_BIN:-/home/sunshuheng/.surrealdb/surreal}"
...
if command -v npm >/dev/null 2>&1; then
  ...
  DEFAULT_NPM_BIN="/home/sunshuheng/.nvm/versions/node/v22.19.0/bin/npm"
fi
...
if command -v node >/dev/null 2>&1; then
  ...
  DEFAULT_NODE_BIN="/home/sunshuheng/.nvm/versions/node/v22.19.0/bin/node"
fi
