...
export const QUERY_KEYS = {
  ...
  duplicateSources: (notebookId: string) => ['notebooks', notebookId, 'duplicate-sources'] as const,
  ...
  summaries: (notebookId: string) => ['summaries', notebookId] as const,
  wikiCards: (notebookId: string) => ['wiki-cards', notebookId] as const,
  sourceWikiCard: (sourceId: string) => ['wiki-cards', 'source', sourceId] as const,
