export const zhCN = {
  ...
  notebooks: {
    ...
    boardInbox: "Inbox",
    boardInboxDesc: "新保存的内容、待分类的想法，以及还没整理的笔记先放这里。",
    boardWorking: "Working",
    boardWorkingDesc: "正在整理、合并或用于当前分析的笔记。",
    boardFinal: "Final",
    boardFinalDesc: "已经沉淀下来的结论、摘录或长期保留的参考笔记。",
    boardEmpty: "这个阶段还没有笔记。",
    moveToInbox: "移动到 Inbox",
    moveToWorking: "移动到 Working",
    moveToFinal: "移动到 Final",
    createNew: "创建新笔记本",
  ...
  sources: {
    ...
    workerLikelyDown: "Worker 可能没有运行",
    workerLikelyDownDesc: "这个来源排队超过 1 分钟仍未开始处理。请检查 `start-worker.sh` 或重启整套服务。",
    ...
    preparing: "正在准备...",
    studio: "Studio",
    studioDesc: "生成可重复使用的来源产物，管理见解，并运行自定义提示词。",
    studioPresets: "预设产物",
    studioBuilder: "自定义生成",
    generateNewInsight: "生成新见解",
    transformationInsight: "使用已有转换",
    transformationInsightDesc: "对这个来源运行一条已经保存的转换规则。",
    paperGuide: "论文导读",
    paperGuideDesc: "一份可反复回看的、带证据引用的论文导读。",
    paperGuideEmpty: "还没有论文导读。生成后可以得到一份结构化且可追溯的概览。",
    generateGuide: "生成导读",
    paperFaq: "论文 FAQ",
    paperFaqDesc: "用问答形式快速覆盖问题、方法、结果和局限。",
    reviewerQuestions: "审稿问题",
    reviewerQuestionsDesc: "从假设、验证和表述不清处提出更尖锐的追问。",
    methodResultsMatrix: "方法结果矩阵",
    methodResultsMatrixDesc: "用表格压缩总结问题、方法、实验设置、指标、结果和局限。",
    latestStudioOutput: "最新产物",
    customInsight: "自定义提示词",
    customInsightDesc: "为当前来源写一次性的总结或分析提示词，结果仍会保存到见解里。",
    customInsightTitlePlaceholder: "例如：聚焦论文批判性总结",
    customInsightPromptPlaceholder: "描述你希望如何总结或分析这条来源",
    createCustomInsight: "用提示词生成",
    selectTransformation: "选择转换规则...",
    noInsightsYet: "暂无见解",
    createFirstInsight: "使用上方的转换规则创建您的第一个见解",
    viewInsight: "查看见解",
    refreshInsight: "刷新",
    refreshingInsight: "刷新中...",
    deleteInsight: "删除见解",
    deleteInsightConfirm: "确定要删除此见解吗？此操作无法撤销。",
    insightGenerationStarted: "见解生成已开始，稍后将显示。",
    insightRefreshStarted: "见解刷新已开始，稍后会出现新的结果。",
    customInsightTitleRequired: "请输入见解标题",
    customInsightPromptRequired: "请输入自定义提示词",
    editNote: "编辑笔记",
    createNote: "创建笔记",
    addTitle: "添加标题...",
    untitledNote: "无标题笔记",
    ...
    sourceInsight: "来源见解",
    evidenceTrail: "证据链",
    evidenceTrailDesc: "可直接检查和引用的嵌入片段，供导读、聊天和 Studio 产物追溯来源。",
    noEvidenceYet: "还没有可用的证据片段。先为这个来源做嵌入，才能建立可追溯的证据链。",
    evidenceDetail: "证据详情",
    evidenceLabel: "证据",
    chunkLabel: "片段 {number}",
    charRange: "字符 {start}-{end}",
    linkedSourceLabel: "关联来源 {id}",
    linkedInsightLabel: "关联见解 {id}",
    linkedSourceShort: "已关联来源",
    linkedInsightShort: "已关联见解",
    ...
    cleanDuplicatesConfirm: "确定要清理重复来源吗？",
    duplicateStats: "在 {groups} 个分组中发现 {count} 个重复来源。",
    failedItems: "失败项目",
    moreFailedAvailable: "还有 {count} 个失败项目可在任务结果中查看。",
    moreFailedOmitted: "还有 {count} 个失败项目已省略。",
    retry: "重试",
  ...
  settings: {
    ...
    pdfEngine: "PDF 处理引擎",
    pdfEnginePlaceholder: "选择 PDF 处理引擎",
    autoRecommended: "自动 (推荐)",
    simple: "Simple",
    docling: "Docling",
    marker: "Marker",
    mineruCloud: "MinerU 云 API",
    mineru: "MinerU",
    helpMeChoose: "帮助我选择",
    ...
    pdfHelp: "· 自动 (推荐): 如果配置了云端 token，会优先尝试 MinerU 云 API，然后回退到本地 MinerU 和 Marker。 · MinerU 云 API 通常更适合零散处理论文，速度更快，也不占本地 CPU/GPU，但依赖公网和官方额度。 · Marker: 本地部署更稳妥，依赖更简单。 · 本地 MinerU: 对公式、复杂版式和部分学术 PDF 可能更强，但需要本地先安装 MinerU 运行环境。",
  ...
  wikiCards: {
    ...
    positioning: "研究定位",
    noExportYet: "暂无导出内容。",
    sourceEvidenceDesc: "以下是 Wiki 卡片所依据的原始来源片段。请检查证据是否真正支持提取的声明。",
    regenerate: "重新生成",
    starting: "启动中…",
    noEvidenceTrail: "此卡片无证据追踪",
    noEvidenceTrailDesc: "此卡片已标记为完成但没有来源片段——可能是在启用证据追踪之前生成的，或当时来源缺少嵌入向量。请重新生成以附加基于证据的追踪。",
    evidence: "证据 {index}",
    noEvidenceSnippets: "此 Wiki 卡片暂无证据片段。",
    match: "匹配",
    openChunk: "打开片段",
    jumpToSource: "跳转到来源",
    unknownSection: "未知章节",
    unavailable: "不可用",
    rangeUnavailable: "范围不可用",
    ...
    retryWikiCard: "重试生成",
    ready: "可更新",
    refreshExisting: "更新已有卡片",
    createMissing: "生成缺失卡片",
    batchRefreshCompleted: "批量更新完成",
    batchRefreshInProgress: "批量更新中",
    batchGenerationCompleted: "批量生成完成",
    batchGenerationInProgress: "批量生成中",
  },
  knowledgeGraph: {
    title: "知识图谱 — {name}",
    description: "论文、概念及其类型化关系的力导向视图。节点大小反映概念中心性；边的颜色/样式反映关系语义。",
    noNodesMatch: "没有节点匹配当前筛选条件。请尝试重置。",
    generateFirst: "请先生成 Wiki 卡片。此图谱读取包含概念/关系数据的已完成卡片。",
    filters: "筛选",
    keyOnly: "仅关键论文",
    genericLinks: "通用链接",
    fit: "适配",
    ...
    relationTypes: "关系类型",
    legend: "图例",
    paperTypesLegend: "论文类型",
    relationTypesLegend: "关系类型",
    conceptSize: "概念（大小 = 关联论文数）",
    selectedNode: "选中节点",
    clickToClear: "点击空白区域清除焦点。",
    clickToFocus: "点击节点以聚焦并查看其邻域。",
    tips: "提示",
    tipConceptSize: "概念节点大小 = 关联论文数量",
    tipClickFit: "点击节点使非邻居变暗，然后点击适配以缩放到该节点",
    tipGenericLinks: "切换通用链接以显示「相关工作」边",
    tipSearch: "可搜索标题、关键词、概念、方法",
    coreConcepts: "核心概念",
    outgoingRelations: "出向关系（{count}）",
    relatedPapers: "{count} 篇相关论文",
    papersUsingConcept: "使用此概念的论文",
    forceLayoutDesc: "力导向布局：链接更多的节点被拉向中心，因此像 PINN / PDE 这样的核心概念自然成为枢纽。笔记本：<strong>{name}</strong>。",
    keyBadge: "关键",
    keyPaperBadge: "关键论文",
    yearNa: "年份未知",
    paper: "论文",
    searchPlaceholder: "搜索标题、概念、关键词…",
  },
  zotero: {
    importFromZotero: "从 Zotero 导入",
    importDescription: "选择一个 Zotero 文集，可选目标笔记本。重新导入到其他笔记本现在会链接现有来源，而不是静默跳过。",
    zoteroCollection: "Zotero 文集",
    loadingCollections: "加载文集中...",
    chooseCollection: "选择文集",
    targetNotebook: "目标笔记本（可选）",
    importWithoutNotebook: "不分配笔记本直接导入",
    noNotebook: "无笔记本",
    skipAlreadyImported: "跳过已导入项目",
    importCollection: "导入文集",
    currentImport: "当前导入",
