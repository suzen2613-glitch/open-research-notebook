export const enUS = {
  ...
  notebooks: {
    ...
    boardInbox: "Inbox",
    boardInboxDesc: "Fresh captures, saved outputs, and notes that still need triage.",
    boardWorking: "Working",
    boardWorkingDesc: "Notes currently being expanded, merged, or actively used in analysis.",
    boardFinal: "Final",
    boardFinalDesc: "Stable notes worth keeping as finished takeaways or references.",
    boardEmpty: "Nothing in this stage yet.",
    moveToInbox: "Move to Inbox",
    moveToWorking: "Move to Working",
    moveToFinal: "Move to Final",
  ...
  sources: {
    ...
    workerLikelyDown: "Worker may not be running",
    workerLikelyDownDesc: "This source has been queued for over a minute without starting. Check `start-worker.sh` or restart the stack.",
    ...
    preparing: "Preparing...",
    studio: "Studio",
    studioDesc: "Generate repeatable source outputs, manage insight artifacts, and run custom prompts.",
    studioPresets: "Studio presets",
    studioBuilder: "Studio builder",
    generateNewInsight: "Generate New Insight",
    transformationInsight: "From transformation",
    transformationInsightDesc: "Run one of your saved transformations against this source.",
    paperGuide: "Paper Guide",
    paperGuideDesc: "A durable, evidence-backed brief you can return to while reading or discussing the paper.",
    paperGuideEmpty: "No paper guide yet. Generate one to get a structured, cited overview of this source.",
    generateGuide: "Generate Guide",
    paperFaq: "Paper FAQ",
    paperFaqDesc: "Quick question-and-answer coverage of the source's problem, method, results, and limits.",
    reviewerQuestions: "Reviewer Questions",
    reviewerQuestionsDesc: "Critical follow-up questions that surface assumptions, missing checks, and unclear claims.",
    methodResultsMatrix: "Method Results Matrix",
    methodResultsMatrixDesc: "A compact table for problem, method, setup, metrics, findings, and limitations.",
    latestStudioOutput: "Latest output",
    customInsight: "Custom prompt",
    customInsightDesc: "Write a one-off prompt for this source and store the result in Insights.",
    customInsightTitlePlaceholder: "e.g., Focused paper critique",
    customInsightPromptPlaceholder: "Describe how this source should be summarized or analyzed",
    createCustomInsight: "Generate with Prompt",
    ...
    insightRefreshStarted: "Insight refresh started. A regenerated version will appear shortly.",
    customInsightTitleRequired: "Please enter an insight title",
    customInsightPromptRequired: "Please enter a custom prompt",
    editNote: "Edit note",
    ...
    evidenceTrailDesc: "Embedded excerpts you can inspect and cite directly from guides, chat answers, and studio outputs.",
    noEvidenceYet: "No evidence excerpts are available yet. Embed this source to build a traceable evidence trail.",
    evidenceDetail: "Evidence Detail",
    evidenceLabel: "evidence",
    chunkLabel: "Chunk {number}",
    charRange: "chars {start}-{end}",
    linkedSourceLabel: "Linked source {id}",
    linkedInsightLabel: "Linked insight {id}",
    linkedSourceShort: "Source linked",
    linkedInsightShort: "Insight linked",
    ...
    cleanDuplicatesConfirm: "Clean duplicate sources?",
    duplicateStats: "Found {count} duplicate source(s) in {groups} group(s).",
    failedItems: "Failed items",
    moreFailedAvailable: "{count} more failed item(s) are available in the job result.",
    moreFailedOmitted: "{count} more failed item(s) omitted.",
    retry: "Retry",
  ...
  settings: {
    ...
    pdfEnginePlaceholder: "Select PDF processing engine",
    autoRecommended: "Auto (Recommended)",
    simple: "Simple",
    docling: "Docling",
    marker: "Marker",
    mineruCloud: "MinerU Cloud API",
    mineru: "MinerU",
    ...
    pdfHelp: "· Auto (recommended) will try MinerU Cloud API first when a cloud token is configured, then fall back to local MinerU and Marker. · MinerU Cloud API is usually much faster for occasional academic PDFs and does not consume local GPU/CPU, but depends on the network and MinerU service quotas. · Marker is the safer local fallback if you want fewer moving parts. · Local MinerU can perform better on formulas and complex layouts, but requires the MinerU runtime to be installed locally.",
  ...
  wikiCards: {
    ...
    claimedGap: "Claimed Gap",
    positioning: "Positioning",
    noExportYet: "No export is available yet.",
    sourceEvidenceDesc: "These are the raw source snippets the wiki card was grounded on. Check whether the evidence actually supports the extracted claims.",
    regenerate: "Regenerate",
    starting: "Starting…",
    noEvidenceTrail: "No evidence trail on this card",
    noEvidenceTrailDesc: "This card is marked completed but has no source snippets — likely generated before evidence tracking was enabled, or the source lacked embeddings at the time. Regenerate to attach grounded evidence.",
    evidence: "Evidence {index}",
    noEvidenceSnippets: "No evidence snippets are available for this wiki card yet.",
    match: "Match",
    ...
    retryWikiCard: "Retry Wiki Card",
    ready: "Ready",
    refreshExisting: "Refresh Existing",
    createMissing: "Create Missing",
    batchRefreshCompleted: "Batch Refresh Completed",
    batchRefreshInProgress: "Batch Refresh In Progress",
    batchGenerationCompleted: "Batch Generation Completed",
    batchGenerationInProgress: "Batch Generation In Progress",
  },
  knowledgeGraph: {
    title: "Knowledge Graph — {name}",
    description: "Force-directed view of papers, concepts, and their typed relations. Node size reflects concept centrality; edge color/style reflects relation semantics.",
    noNodesMatch: "No nodes match the current filters. Try resetting.",
    generateFirst: "Generate Wiki Cards first. This graph reads completed cards with concept/relation data.",
    filters: "Filters",
    keyOnly: "Key only",
    ...
    legend: "Legend",
    paperTypesLegend: "Paper types",
    relationTypesLegend: "Relation types",
    conceptSize: "Concept (size = # papers)",
    selectedNode: "Selected node",
    clickToClear: "Click empty space to clear focus.",
    clickToFocus: "Click a node to focus and see its neighborhood.",
    tips: "Tips",
    tipConceptSize: "Node size of concepts = number of papers linked",
    tipClickFit: "Click a node to dim non-neighbors, then <em>Fit</em> to zoom onto it",
    tipGenericLinks: "Toggle <em>Generic links</em> to show &quot;related work&quot; edges",
    tipSearch: "Search on titles, keywords, concepts, methods",
    coreConcepts: "Core concepts",
    outgoingRelations: "Outgoing relations ({count})",
    relatedPapers: "{count} related papers",
    papersUsingConcept: "Papers using this concept",
    forceLayoutDesc: "Force-directed layout: nodes with more links are pulled into the center, so central concepts like PINN / PDE act as natural hubs. Notebook: <strong>{name}</strong>.",
    keyBadge: "KEY",
    keyPaperBadge: "Key paper",
    yearNa: "year n/a",
    paper: "paper",
    searchPlaceholder: "Search title, concept, keyword…",
  },
  zotero: {
    importFromZotero: "Import from Zotero",
    importDescription: "Choose a Zotero collection and optionally a target notebook. Re-importing into another notebook now links existing sources instead of silently doing nothing.",
    zoteroCollection: "Zotero Collection",
    loadingCollections: "Loading collections...",
    chooseCollection: "Choose a collection",
    targetNotebook: "Target Notebook (optional)",
    importWithoutNotebook: "Import without assigning a notebook",
    noNotebook: "No notebook",
    skipAlreadyImported: "Skip already imported items",
    ...
    recentImportJobs: "Recent Import Jobs",
