export const enUS = {
  common: {
    ...
    appName: "Open Research Notebook",
    add: "Add",
    remove: "Remove",
    confirm: "Confirm",
    warning: "Warning",
  ...
  connectionErrors: {
    ...
    apiDesc: "The Open Research Notebook API server could not be reached",
    ...
    docLink: "Open Research Notebook Documentation",
  ...
  auth: {
    loginTitle: "Open Research Notebook",
